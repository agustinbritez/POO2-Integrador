...
public class Persistencia {
    ...
    /*public <T extends Object> List<T> buscarTodosConAtributo(Class<T> clase, SingularAttribute<T, P> orden, String comparacion) {
        CriteriaBuilder cb = this.em.getCriteriaBuilder();
        CriteriaQuery<T> consulta = cb.createQuery(clase);
        Root<T> inicio = consulta.from(clase);
        consulta.where(cb.equal(orden, comparacion));
        return em.createQuery(consulta).getResultList();
    }*/
